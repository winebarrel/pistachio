...
type DropPolicy struct {
	AllowDrop []string `enum:"all,table,view,enum,domain,composite_type,sequence,routine,column,constraint,foreign_key,index,policy,trigger" env:"PISTA_ALLOW_DROP" help:"Allow dropping these object types (repeatable; 'all' allows everything)."`
}
