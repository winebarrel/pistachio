...
func TestParseSQL_VirtualGeneratedColumn(t *testing.T) {
...
func TestParseSQL_ColumnLevelExclusionConstraint(t *testing.T) {
	// EXCLUSION constraint at column level with explicit name
	sql := `CREATE TABLE public.reservations (
    id integer NOT NULL,
    room integer NOT NULL,
    during tsrange NOT NULL,
