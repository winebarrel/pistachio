...
func orderFromSchema(
	...
	return toposort.OrderFromSchema(enums, domains, orderedmap.New[string, *model.CompositeType](), tables, views, orderedmap.New[string, *model.Sequence](), orderedmap.New[string, *model.Routine]())
}
