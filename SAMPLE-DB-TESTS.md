...
- openreplay and logto 2026-09-20 on 16.13.
...
| **Total** | **8,740** | **74,897** | **26,370** | **10,886** | **14,360** | **2,203** | **622** | **509** | **1,599** | **1,294** |

### Size

The 89 dumps come to about 243,000 lines of SQL. chado is 43,700 of them, the
...
Routines are concentrated the same way. Forty-one of the 89 samples declare
one at all, and gitlab's 337, boundary's 225, kea's and musicbrainz's 130 each,
and chado's 94 are 916 of the 1,294. Seven in ten of them, 903, return
...
1,188 are written in plpgsql and 106 in sql. sourcegraph declares one
